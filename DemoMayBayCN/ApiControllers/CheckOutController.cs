...
namespace DemoMayBayCN.ApiControllers
{
    ...
    public class CheckOutController : ControllerBase
    {
       ...
       /* [HttpPost]
        ...
        [HttpGet]
        [Route("GetFlightSelection")]
        public IActionResult GetFlightSelection()
        {
            if (_memoryCache.TryGetValue("flightSelection", out List<Flights> flightSelection))
            {
                // Trả về thông tin đã chọn và đã điền
                return Ok(new { status = true, message = "", flightSelection = flightSelection });
            }
            else
            {
                return BadRequest("Booking information not found.");
        ...
        [HttpGet]
        [Route("GetFlightReturnSelection")]
        public IActionResult GetFlightReturnSelection()
        {
            if (_memoryCache.TryGetValue("FlightReturnSelection", out List<Flights> flightSelection))
            {
                // Trả về thông tin đã chọn và đã điền
                return Ok(new { status = true, message = "", flightReturnSelection = flightSelection });
            }
            else
            {
                return BadRequest("Booking information not found.");
        ...
        [HttpGet]
        [Route("GetSeatSelection")]
        public IActionResult GetSeatSelection()
        {
            if (_memoryCache.TryGetValue("seatSelection", out List<Seats> seatSelection))
            {
                // Trả về thông tin đã chọn và đã điền
        ...
        [HttpGet]
        [Route("GetSeatReturnSelection")]
        public IActionResult GetSeatReturnSelection()
        {
            if (_memoryCache.TryGetValue("seatReturnSelection", out List<Seats> seatSelection))
            {
                // Trả về thông tin đã chọn và đã điền
                return Ok(new { status = true, message = "", seatReturnSelection = seatSelection });
            }
            else
            {
                return BadRequest("Booking information not found.");
        ...
        [HttpGet]
        [Route("GetProcessBooking")]
        public IActionResult GetProcessBooking()
        {
            if (_memoryCache.TryGetValue("passengerSelection", out List<PassengersRequest> passengersSelection))
            {
                // Trả về thông tin đã chọn và đã điền
                return Ok(new { status = true, message = "", passengersSelection = passengersSelection });
            }
            else
            {
                return BadRequest("Booking information not found.");
        ...
        [HttpGet]
        [Route("GetFlightSeatSelection")]
        public IActionResult GetFlightSeatSelection()
        {
            if (_memoryCache.TryGetValue("flightSelection", out List<Flights> flightSelection) && _memoryCache.TryGetValue("seatSelection", out List<Seats> seatSelection))
            {
                // Trả về thông tin đã chọn và đã điền
                return Ok(new { status = true, message = "", flightSelection = flightSelection, seatSelection = seatSelection});
            }
            else
            {
                return BadRequest("Booking information not found.");
